...
import com.example.dxcfitnesstracker.ui.communication.IOnBarClickedListener;
...
public abstract class BaseBarChart extends BaseChart {
     ...
     */
    protected abstract List<BarModel> getLegendData();
    ...
    protected void onLegendDraw(Canvas _Canvas) {
        ...
        for (BarModel model : getLegendData()) {
